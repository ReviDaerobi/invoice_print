    ...
    <main class="flex-1 overflow-y-auto bg-gray-50 p-4 sm:p-6 lg:p-8">
        ...
        <div class="bg-white rounded-xl shadow overflow-hidden">
            <div class="p-6 border-b">
                <h3 class="text-lg font-semibold text-gray-800">Edit Informasi Produk</h3>
                <p class="text-sm text-gray-500 mt-1">Ubah informasi produk yang ada dalam sistem</p>
            </div>

            <form action="{{ route('produk.update', $produk->ItemId) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="ItemId" id="ItemId" value="{{ old('ItemId', $produk->ItemId) }}" 
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                            placeholder="Contoh: PROD001">
                        <p class="mt-1 text-xs text-gray-500">ID unik untuk produk ini</p>
                    </div>

                    <!-- Item Name -->
                    <div>
                        <label for="ItemName" class="block text-sm font-medium text-gray-700 mb-1">Nama Produk</label>
                        <input type="text" name="ItemName" id="ItemName" value="{{ old('ItemName', $produk->ItemName) }}" 
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                    ...
                    <div>
                        ...
                        <select name="Unit" id="Unit" 
                            ...
                            <option value="Kg" {{ old('Unit', $produk->Unit) == 'Kg' ? 'selected' : '' }}>Kg</option>
                            <option value="Set" {{ old('Unit', $produk->Unit) == 'Set' ? 'selected' : '' }}>Set</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="UnitPrice" id="UnitPrice" value="{{ old('UnitPrice', number_format($produk->UnitPrice, 0, ',', '.')) }}" 
